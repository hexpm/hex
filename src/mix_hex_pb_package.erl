...
dfp_read_field_def_Package(<<26, Rest/binary>>, Z1, Z2,
                           F@_1, F@_2, F@_3, TrUserData) ->
    d_field_Package_repository(Rest,
                               Z1,
                               Z2,
                               F@_1,
                               F@_2,
...
d_msg_Release(Bin, TrUserData) ->
    dfp_read_field_def_Release(Bin,
                               0,
                               0,
                               id('$undef', TrUserData),
                               id('$undef', TrUserData),
...
dfp_read_field_def_Release(<<18, Rest/binary>>, Z1, Z2,
                           F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_Release_inner_checksum(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   F@_2,
...
dfp_read_field_def_Release(<<26, Rest/binary>>, Z1, Z2,
                           F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_Release_dependencies(Rest,
                                 Z1,
                                 Z2,
                                 F@_1,
                                 F@_2,
...
dfp_read_field_def_Release(<<42, Rest/binary>>, Z1, Z2,
                           F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_Release_outer_checksum(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   F@_2,
...
dfp_read_field_def_Release(Other, Z1, Z2, F@_1, F@_2,
    ...
    dg_read_field_def_Release(Other,
                              Z1,
                              Z2,
                              F@_1,
                              F@_2,
...
dg_read_field_def_Release(<<1:1, X:7, Rest/binary>>, N,
    ...
    when N < 32 - 7 ->
    dg_read_field_def_Release(Rest,
                              N + 7,
                              X bsl N + Acc,
                              F@_1,
                              F@_2,
            ...
            case Key band 7 of
                ...
                1 ->
                    skip_64_Release(Rest,
                                    ...
                                    TrUserData);
                2 ->
                    skip_length_delimited_Release(Rest,
                                                  0,
                                                  0,
                                                  F@_1,
                                                  F@_2,
...
skip_varint_Release(<<0:1, _:7, Rest/binary>>, Z1, Z2,
                    F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_Release(Rest,
                               Z1,
                               Z2,
                               F@_1,
                               F@_2,
...
skip_length_delimited_Release(<<0:1, X:7, Rest/binary>>,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_Release(Rest2,
                               0,
                               0,
                               F@_1,
                               F@_2,
...
d_msg_RetirementStatus(Bin, TrUserData) ->
    dfp_read_field_def_RetirementStatus(Bin,
                                        0,
                                        0,
                                        id('$undef', TrUserData),
                                        id('$undef', TrUserData),
...
dfp_read_field_def_RetirementStatus(<<8, Rest/binary>>,
    ...
    d_field_RetirementStatus_reason(Rest,
                                    Z1,
                                    Z2,
                                    F@_1,
                                    F@_2,
...
dfp_read_field_def_RetirementStatus(<<18, Rest/binary>>,
                                    Z1, Z2, F@_1, F@_2, TrUserData) ->
    d_field_RetirementStatus_message(Rest,
                                     Z1,
                                     Z2,
                                     F@_1,
                                     F@_2,
...
dfp_read_field_def_RetirementStatus(Other, Z1, Z2, F@_1,
                                    F@_2, TrUserData) ->
    dg_read_field_def_RetirementStatus(Other,
                                       Z1,
                                       Z2,
                                       F@_1,
                                       F@_2,
...
dg_read_field_def_RetirementStatus(<<1:1, X:7,
    ...
    when N < 32 - 7 ->
    dg_read_field_def_RetirementStatus(Rest,
                                       N + 7,
                                       X bsl N + Acc,
                                       F@_1,
                                       F@_2,
...
dg_read_field_def_RetirementStatus(<<0:1, X:7,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                0 ->
                    skip_varint_RetirementStatus(Rest,
                                                 0,
                                                 0,
                                                 F@_1,
                                                 F@_2,
                ...
                1 ->
                    skip_64_RetirementStatus(Rest,
                                             ...
                                             TrUserData);
                2 ->
                    skip_length_delimited_RetirementStatus(Rest,
                                                           0,
                                                           0,
                                                           F@_1,
                                                           F@_2,
                                                           TrUserData);
                3 ->
                    skip_group_RetirementStatus(Rest,
                                                Key bsr 3,
                                                0,
                                                F@_1,
                                                F@_2,
...
d_field_RetirementStatus_reason(<<0:1, X:7,
    ...
    {NewFValue, RestF} = {id(d_enum_RetirementReason(begin
                             ...
                             TrUserData),
                          Rest},
    dfp_read_field_def_RetirementStatus(RestF,
                                        0,
                                        0,
                                        NewFValue,
                                        F@_2,
...
skip_varint_RetirementStatus(<<0:1, _:7, Rest/binary>>,
                             Z1, Z2, F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_RetirementStatus(Rest,
                                        Z1,
                                        Z2,
                                        F@_1,
                                        F@_2,
...
skip_length_delimited_RetirementStatus(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_RetirementStatus(Rest2,
                                        0,
                                        0,
                                        F@_1,
                                        F@_2,
...
d_msg_Dependency(Bin, TrUserData) ->
    dfp_read_field_def_Dependency(Bin,
                                  0,
                                  0,
                                  id('$undef', TrUserData),
                                  id('$undef', TrUserData),
...
dfp_read_field_def_Dependency(<<10, Rest/binary>>, Z1,
    ...
    d_field_Dependency_package(Rest,
                               Z1,
                               Z2,
                               F@_1,
                               F@_2,
...
dfp_read_field_def_Dependency(<<18, Rest/binary>>, Z1,
                              Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_Dependency_requirement(Rest,
                                   Z1,
                                   Z2,
                                   F@_1,
                                   F@_2,
...
dfp_read_field_def_Dependency(<<24, Rest/binary>>, Z1,
                              Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_Dependency_optional(Rest,
                                Z1,
                                Z2,
                                F@_1,
                                F@_2,
...
dfp_read_field_def_Dependency(<<42, Rest/binary>>, Z1,
                              Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    d_field_Dependency_repository(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
...
dfp_read_field_def_Dependency(Other, Z1, Z2, F@_1, F@_2,
                              F@_3, F@_4, F@_5, TrUserData) ->
    dg_read_field_def_Dependency(Other,
                                 Z1,
                                 Z2,
                                 F@_1,
                                 F@_2,
...
dg_read_field_def_Dependency(<<1:1, X:7, Rest/binary>>,
                             N, Acc, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData)
    when N < 32 - 7 ->
    dg_read_field_def_Dependency(Rest,
                                 N + 7,
                                 X bsl N + Acc,
                                 F@_1,
                                 F@_2,
            ...
            case Key band 7 of
                ...
                1 ->
                    skip_64_Dependency(Rest,
                                       ...
                                       TrUserData);
                2 ->
                    skip_length_delimited_Dependency(Rest,
                                                     0,
                                                     0,
                                                     F@_1,
                                                     F@_2,
...
d_field_Dependency_package(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_Dependency(RestF,
                                  0,
                                  0,
                                  NewFValue,
                                  F@_2,
...
skip_varint_Dependency(<<0:1, _:7, Rest/binary>>, Z1,
                       Z2, F@_1, F@_2, F@_3, F@_4, F@_5, TrUserData) ->
    dfp_read_field_def_Dependency(Rest,
                                  Z1,
                                  Z2,
                                  F@_1,
                                  F@_2,
...
skip_length_delimited_Dependency(<<0:1, X:7,
    ...
    Length = X bsl N + Acc,
    <<_:Length/binary, Rest2/binary>> = Rest,
    dfp_read_field_def_Dependency(Rest2,
                                  0,
                                  0,
                                  F@_1,
                                  F@_2,
...
merge_msg_Release(#{} = PMsg,
    ...
    S3 = case {PMsg, NMsg} of
             {#{retired := PFretired}, #{retired := NFretired}} ->
                 S2#{retired =>
                         merge_msg_RetirementStatus(PFretired,
                                                    NFretired,
                                                    TrUserData)};
             {_, #{retired := NFretired}} ->
    ...
    case M of
        #{releases := F1} ->
            if is_list(F1) ->
                   ...
                   ok;
               true ->
                   mk_type_error({invalid_list_of, {msg, 'Release'}},
                                 F1,
                                 [releases | Path])
            end;
        _ -> ok
...
v_msg_Release(M, Path, _TrUserData) when is_map(M) ->
    mk_type_error({missing_fields,
                   [version, inner_checksum] -- maps:keys(M),
                   'Release'},
                  M,
                  Path);
...
v_msg_RetirementStatus(X, Path, _TrUserData) ->
    mk_type_error({expected_msg, 'RetirementStatus'},
                  X,
                  Path).
...
v_msg_Dependency(M, Path, _TrUserData) when is_map(M) ->
    mk_type_error({missing_fields,
                   [package, requirement] -- maps:keys(M),
                   'Dependency'},
                  M,
                  Path);
...
v_enum_RetirementReason(X, Path, _TrUserData) ->
    mk_type_error({invalid_enum, 'RetirementReason'},
                  X,
                  Path).
