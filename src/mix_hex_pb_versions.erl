...
d_msg_Versions(Bin, TrUserData) ->
    dfp_read_field_def_Versions(Bin,
                                0,
                                0,
                                id([], TrUserData),
                                id('$undef', TrUserData),
...
dfp_read_field_def_Versions(<<10, Rest/binary>>, Z1, Z2,
    ...
    d_field_Versions_packages(Rest,
                              Z1,
                              Z2,
                              F@_1,
                              F@_2,
...
dfp_read_field_def_Versions(<<18, Rest/binary>>, Z1, Z2,
                            F@_1, F@_2, TrUserData) ->
    d_field_Versions_repository(Rest,
                                Z1,
                                Z2,
                                F@_1,
                                F@_2,
...
dfp_read_field_def_Versions(Other, Z1, Z2, F@_1, F@_2,
                            TrUserData) ->
    dg_read_field_def_Versions(Other,
                               Z1,
                               Z2,
                               F@_1,
                               F@_2,
...
dg_read_field_def_Versions(<<1:1, X:7, Rest/binary>>, N,
    ...
    when N < 32 - 7 ->
    dg_read_field_def_Versions(Rest,
                               N + 7,
                               X bsl N + Acc,
                               F@_1,
                               F@_2,
    ...
    case Key of
        ...
        _ ->
            case Key band 7 of
                ...
                2 ->
                    skip_length_delimited_Versions(Rest,
                                                   0,
                                                   0,
                                                   F@_1,
                                                   F@_2,
...
d_field_Versions_packages(<<0:1, X:7, Rest/binary>>, N,
    ...
    dfp_read_field_def_Versions(RestF,
                                0,
                                0,
...
skip_varint_Versions(<<0:1, _:7, Rest/binary>>, Z1, Z2,
                     F@_1, F@_2, TrUserData) ->
    dfp_read_field_def_Versions(Rest,
                                Z1,
                                Z2,
                                F@_1,
                                F@_2,
...
skip_length_delimited_Versions(<<0:1, X:7,
    ...
    dfp_read_field_def_Versions(Rest2,
                                0,
                                0,
                                F@_1,
                                F@_2,
...
d_pfield_Package_retired(<<0:1, X:7, Rest/binary>>, N,
    ...
    NewSeq = d_packed_field_Package_retired(PackedBytes,
                                            0,
                                            0,
                                            E,
                                            TrUserData),
...
d_packed_field_Package_retired(<<1:1, X:7,
    ...
    when N < 57 ->
    d_packed_field_Package_retired(Rest,
                                   N + 7,
                                   X bsl N + Acc,
                                   AccSeq,
                                   TrUserData);
d_packed_field_Package_retired(<<0:1, X:7,
    ...
    {NewFValue, RestF} = {begin
                          ...
                          Rest},
    d_packed_field_Package_retired(RestF,
                                   0,
                                   0,
                                   [NewFValue | AccSeq],
                                   TrUserData);
