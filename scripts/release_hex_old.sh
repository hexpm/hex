...
function build {
  ...
  docker run -v $(pwd):/hex hexpm/elixir:${3}-erlang-${2}-ubuntu-${5} sh -c " \
    cd /hex && \
    MIX_ENV=prod mix archive.build -o hex.ez && \
    MIX_ENV=prod mix archive.build -o hex-${1}.ez"

  mv hex.ez hex-elixir-${4}.ez
...
hex_csv "${hex_version}" 1.6.0 1.7.0 1.8.0 1.9.0 1.10.0 1.11.0 1.12.0 1.13.0 1.14.0 1.15.0 1.16.0 1.17.0 1.18.0
upload  "${hex_version}" 1.6.0 1.7.0 1.8.0 1.9.0 1.10.0 1.11.0 1.12.0 1.13.0 1.14.0 1.15.0 1.16.0 1.17.0 1.18.0
