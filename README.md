...
Install by running in your shell `mix local.install http://storage.hex.pm/installs/hex.ez && mix hex.update`. The Hex installation can later be updated with `mix hex.update --system`.
