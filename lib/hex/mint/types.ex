...
defmodule Hex.Mint.Types do
  ...
  can connect each response to the right request. Also see `Hex.Mint.HTTP.request/5`.
  """
  ...
  Terms of this type are returned as responses to requests. See `Hex.Mint.HTTP.stream/2`
  ...
  An error reason.
  """
  @type error() :: Hex.Mint.TransportError.t() | Hex.Mint.HTTPError.t()
