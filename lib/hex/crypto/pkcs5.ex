defmodule Hex.Crypto.PKCS5 do
  ...
  defp pbkdf2_iterate(password, salt, iterations, hash, rounds, rounds, derived_keying_material) do
    derived_keying_material <> pbkdf2_exor(password, salt, iterations, hash, 1, rounds, <<>>, <<>>)
  end
  ...
  defp pbkdf2_exor(_password, _salt, iterations, _hash, i, _counter, _prev, curr) when i > iterations do
    curr
  end
