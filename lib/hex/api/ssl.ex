defmodule Hex.API.SSL do
  ...
  # From https://wiki.mozilla.org/Security/Server_Side_TLS intermediate compatability
  @default_ciphers [
    'ECDHE-ECDSA-CHACHA20-POLY1305-SHA256', 'ECDHE-RSA-CHACHA20-POLY1305-SHA256', 'ECDHE-ECDSA-AES128-GCM-SHA256',
